...
def add_preprocess_args(parser):
    ...
    group.add_argument("--train-doc", metavar="DIR", default="",
                       help="destination dir")
    group.add_argument("--dev-doc", metavar="DIR", default="",
                       help="destination dir")
    group.add_argument("--test-doc", metavar="DIR", default="",
                       help="destination dir")
    group.add_argument("--process-doc", action="store_true",
                       help="Only process the source language")
    # fmt: on
    return parser
