...
def get_from_cache(url, cache_dir=None):
    ...
    print('cache_dir', cache_dir, url)
    # Get eTag to add to filename, if it exists.
    if url.startswith("s3://"):
        etag = s3_etag(url)
    elif url == "https://dl.fbaipublicfiles.com/fairseq/gpt2_bpe/encoder.json":
        etag = r'W/"dffec25a898b1f5e569bec4dffd7e5c0"'
    elif url == "https://dl.fbaipublicfiles.com/fairseq/gpt2_bpe/vocab.bpe":
        etag = r'W/"75a37753dd7a28a2c5df80c28bf06e4e"'
    else:
        try:
            import requests
