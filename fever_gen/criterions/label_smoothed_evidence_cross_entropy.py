...
@register_criterion(
    "fever_evidence_label_smoothed_cross_entropy", dataclass=LabelSmoothedCrossEntropyCriterionConfig
)
class LabelSmoothedEvidenceCrossEntropyCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        # evidence_target = F.pad(evidence_target, (0, 1), value=ignore_index)
        ...
        return e_loss, e_nll_loss, e_sample_size
